...
public class Test {
	...
	public static void main(String[] args) {
		...
		Ocjena[] o1 = { new Ocjena(55, pr[0]), new Ocjena(48, pr[1]), new Ocjena(65, pr[3]), new Ocjena(67, pr[2]) };
		Ocjena[] o2 = { new Ocjena(49, pr[0]), new Ocjena(90, pr[1]), new Ocjena(77, pr[3]), new Ocjena(85, pr[2]) };
		Ocjena[] o3 = { new Ocjena(88, pr[0]), new Ocjena(68, pr[1]), new Ocjena(77, pr[3]), new Ocjena(100, pr[2]) };
		Ocjena[] o4 = { new Ocjena(90, pr[0]), new Ocjena(71, pr[1]), new Ocjena(81, pr[3]), new Ocjena(50, pr[2]) };
